...
def userinput_function():
    ...
    return receiver_list, sender, subject, body

# -- Send email here: --
def send_emails(receiver_list, sender, subject, body, password):
...
if(__name__ == "__main__"):
    ...
    receiver_list, sender, subject, body = userinput_function()
